...
from .views import ProductListView, ProductDetailView, add_review, ProductViewSet, CategoryViewSet, CartApiViewSet
...
# include в config/urls: path("api/", include("products.urls", namespace="api-products"))
urlpatterns += [
